...
const Navbar = () => {
  return (
    <nav className="bg-white flex w-full z-20 text-stone-500 sticky top-0 pr-4  justify-between border-b border-stone-150 box-border items-center p-2 sm:p-4 gap-8 xl:text-lg  ">
